...
model = MLPBottleneckModel().to(DEVICE)
...
for epoch in range(epochs):
    ...
    if val_acc > best_accuracy:
        ...
        torch.save(
            ...
            "experiments/mlp_bottleneck/best_mlp_bottleneck.pth"
