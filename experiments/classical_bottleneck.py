...
class ClassicalBottleneck(nn.Module):
    ...
    def __init__(self):
        ...
        # Same bottleneck size as quantum layer
...
for epoch in range(epochs):
    ...
    if val_acc > best_accuracy:
        ...
        torch.save(
            ...
            "experiments/classical_bottleneck/best_classical_bottleneck.pth"
...
print(
    "Best Classical Bottleneck Accuracy:",
    best_accuracy
)